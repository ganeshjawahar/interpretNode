...
./reconstruct -train ../../../graphs/edgelist/graph3 -output net_dense.txt -depth 2 -k-max 1000
...
./normalize -input vec_1st_wo_norm.txt -output ../../../graphs/embeddings/graph3_line_1st.txt -binary 1
./normalize -input vec_2nd_wo_norm.txt -output ../../../graphs/embeddings/graph3_line_2nd.txt -binary 1
./concatenate -input1 ../../../graphs/embeddings/graph3_line_1st.txt -input2 ../../../graphs/embeddings/graph3_line_2nd.txt -output ../../../graphs/embeddings/graph3_line_all.txt -binary 1
