...
graph = "edgelist/graph1"
outputfilefolder = "outlierscore/graph1/"
...
def main():
	filenames = ["graph5_dw","graph5_1st.txt","graph5_2nd.txt","graph5_all.txt"]
	p=[0.25,0.5,1,2,4]
	for i in p:
		for j in p:
			filenames.append("author-"+str(i)+"-"+str(j))
	print filenames
